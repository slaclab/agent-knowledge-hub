...
export function SubmitForm({ accessInstructionsUrl = "/guides/slac-github-access" }: { accessInstructionsUrl?: string }) {
      ...
      <div className="space-y-1">
        ...
        {preview?.visibility === "internal" && (
          <div className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-800">
            ...
            <a href={accessInstructionsUrl} className="underline" target="_blank">
              Learn more
            </a>
          </div>
        )}
